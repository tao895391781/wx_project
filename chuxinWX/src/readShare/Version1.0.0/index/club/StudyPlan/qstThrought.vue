  ...
  methods:{
   ...
   showTrue(){
      ...
      for(let i =0;i<this.selected.length;i++){
        if(this.selected[i].answer=='' || this.selected[i].answer.length==0){
    ...
    .then(res=>{
      ...
      if(res.data.flag){
        ...
        console.log(this.ip.RESTPATH+'rest/postReadingTest')
        this.axios.post(this.ip.RESTPATH+'rest/postReadingTest',postdata1)
        .then(res=>{
          console.log(res.data);
          this.trueSub = false;
          this.$router.push({name:'qstThroughtResult',query:{id:this.$route.query.id}})
        })
      }
    })
...
// });
  ...
  created(){
     ...
     let id = this.$route.query.id;
      this.axios.get(this.ip.RESTPATH+'rest/getReadingTestByReadingTestId/'+ id)
      .then(res=>{
        console.log(res.data);
