 const citydata= [{ name: "北京", cities: ["西城", "东城", "崇文", "宣武", "朝阳", "海淀", "丰台", "石景山", "门头沟", "房山", "通州", "顺义", "大兴", "昌平", "平谷", "怀柔", "密云", "延庆"] },
          ...
          { name:"台湾"}];
 const data1 = [{text:'6岁',value:6},{text:'7岁',value:7},{text:'8岁',value:8},{text:'9岁',value:9},{text:'                10岁',value:10},{text:'11岁',value:11},{text:'12岁',value:12},{text:'13岁',value:13},
                    {text:'14岁',value:14},{text:'15岁',value:15},{text:'16岁',value:16},{text:'17岁',value:17},
                    {text:'18岁',value:18},{text:'18岁以上',value:19}];
 const data2 = [{text:'一年级',value:1},{text:'二年级',value:2},{text:'三年级',value:3},{text:'四年级',                  value:4},{text:'五年级',value:5},{text:'六年级',value:6},{text:'七年级',value:7},{text:'                     八年级',value:8},{text:'九年级',value:9},{text:'十年级',value:10},{text:'十一年级',                    value:11},{text:'十二年级',value:12},{text:'高中毕业',value:13}];
 const options = [{
                         value: '选项1',
                         label: '1年级'
                       }, {
...
module.exports = {citydata,data1,data2,options,option2,option3}
